...
static void ReadUserInput(float &start_x, float &start_y, float &end_x, float &end_y)
{
    ReadValue(start_x, "Enter start X: ");
    ReadValue(start_y, "Enter start Y: ");
    ReadValue(end_x, "Enter end X: ");
    ReadValue(end_y, "Enter end Y: ");
}
